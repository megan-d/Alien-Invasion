...
def check_events(ai_settings, screen, ship: Ship, bullets) -> None:
...
def fire_bullet(ai_settings, screen, ship: Ship, bullets):
...
def get_number_rows(ai_settings, ship_height, alien_height) -> int:
...
def create_fleet(ai_settings, screen, ship: Ship, aliens):
